...
public class daftarBuku extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Tabel Daftar Buku pada Perpustakaan STMIK LOGIKA Medan");
        ...
        cbxKategori.setFont(new java.awt.Font("Arial", 0, 14));
        ...
        jLabel3.setText("Cari Berdasarkan Kategori");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(cbxKategori, javax.swing.GroupLayout.PREFERRED_SIZE, 134, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btnCariKategoriActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCariKategoriActionPerformed
        ...
        DefaultTableModel model = new DefaultTableModel();
            ...
            try {
                Statement statement = (Statement)connect.GetConnection().createStatement();
                ResultSet res = statement.executeQuery
                        ("select * from tbl_buku where nama_kategori = '"+kategori+"'");
                while(res.next())
                {
                    model.addRow(new Object[]{
                        res.getString("kode_buku"),
